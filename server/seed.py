...
with app.app_context():
    ...
    certificates = [
        Certificate(student_id=User3.public_id, course_id=Course1._id, issued_on=datetime.now().strftime("%d/%m/%Y")),
        Certificate(student_id=User4.public_id, course_id=Course2._id, issued_on=datetime.now().strftime("%d/%m/%Y")),
        Certificate(student_id=User5.public_id, course_id=Course3._id, issued_on=datetime.now().strftime("%d/%m/%Y")),
        Certificate(student_id=User3.public_id, course_id=Course3._id, issued_on=datetime.now().strftime("%d/%m/%Y"))
    ]
